<template>
  dicom
<!-- <input type="hidden" id="assets" value="{{ url }}">
  <header class="page-header" id="page-header">
    <span id="icon-list">
      <span id="openFile_span"><img class="img" type="file" alt="開檔" id="openFile"
          src="{{ url }}/image/icon/black/openfile.png" width="50" height="50"></span>
      <span id="MouseOperation_span"><img class="img VR MPR SEG" alt="平移與縮放" id="MouseOperation"
          src="{{ url }}/image/icon/black/b_Pan.png" width="50" height="50"></span>
      <span id="b_Scroll_span"><img class="img MPR" alt="b_Scroll" id="b_Scroll" src="{{ url }}/image/icon/black/b_Scroll.png"
          width="50" height="50"></span>
      <span id="annotation1_span"><img class="img" alt="分隔" id="annotation1"
          src="{{ url }}/image/icon/black/b_LayoutWithinViewport.png" width="50" height="50"></span>
      <span id="MouseRotate_span"><img class="img MPR" alt="旋轉" id="MouseRotate"
          src="{{ url }}/image/icon/black/b_Rotate 90 degrees clockwise.png" width="50" height="50"></span>
      <span id="WindowRevision_span"><img class="img VR MPR SEG" alt="Window Level" id="WindowRevision"
          src="{{ url }}/image/icon/black/b_Window.png" width="50" height="50"></span>
      <span id="zoom_span"><img class="img" alt="放大鏡" id="zoom" src="{{ url }}/image/icon/black/b_Zoom.png" width="50"
          height="50"></span>
      <span id="horizontal_flip_span"><img class="img" alt="水平翻轉" id="horizontal_flip"
          src="{{ url }}/image/icon/black/b_FlipHorizontally.png" width="50" height="50"></span>
      <span id="vertical_flip_span"><img class="img" alt="垂直翻轉" id="vertical_flip" src="{{ url }}/image/icon/black/b_垂直翻轉.png"
          width="50" height="50"></span>
      <span id="color_invert_span"><img class="img" alt="色彩反轉" id="color_invert"
          src="{{ url }}/image/icon/black/b_InvertGrayscale.png" width="50" height="50"></span>
      <span id="unlink_span"><img class="img" alt="連接" id="unlink"
          src="{{ url }}/image/icon/black/b_unlink translation synchronization.png" width="50" height="50"></span>
      <span style="position:relative;">
        <img class="img" id="openMeasureImg" src="{{ url }}/image/icon/black/M.png" width="50" height="50">
        ...
        width: 500; display: none;background-color: black;">
          <span id="removeRuler_span">
            <img alt="清除測量" id="removeRuler" src="{{ url }}/image/icon/black/X.png" width="50" height="50">
          </span>
          <span id="MeasureRuler_span">
            <img alt="測量" id="MeasureRuler" src="{{ url }}/image/icon/black/b_DistanceMeasurement.png" width="50" height="50">
          </span>
          <span id="AngleRuler_span">
            <img alt="角度" id="AngleRuler" src="{{ url }}/image/icon/black/b_AngleMeasurement.png" width="50" height="50">
          </span>
        </div>
      </span>

      <span id="playvideo_span"><img class="img" alt="播放" id="playvideo" src="{{ url }}/image/icon/black/b_CinePlay.png"
          width="50" height="50"></span>
      <span id="MarkButton_span"><img class="img VR MPR" alt="標記" id="MarkButton" src="{{ url }}/image/icon/black/fist0.png"
          width="50" height="50"></span>
      <span id="annotation_span"><img class="img" alt="標籤" id="annotation" src="{{ url }}/image/icon/black/b_Annotation.png"
          width="50" height="50"></span>
      <span id="MarkupImg_span"><img class="img VR MPR" alt="AIM" id="MarkupImg"
          src="{{ url }}/image/icon/black/b_ShowReport.png" width="50" height="50"></span>
    </span>
    <span id="rwdImgTag_span"> <img class="img VR MPR XML PEN" alt="RWD" id="rwdImgTag"
        src="{{ url }}/image/icon/black/b_CineTools.png" style="display:none;" width="50" height="50"></span>
